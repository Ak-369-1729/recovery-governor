...
class GovernorOperatingMode(str, Enum):
...
class AutonomyLevel(str, Enum):
    ...
    LEVEL_2_SHADOW = "LEVEL_2_SHADOW"
    LEVEL_3_GOVERNED = "LEVEL_3_GOVERNED"
    LEVEL_4_CONSTRAINED_AUTONOMOUS = "LEVEL_4_CONSTRAINED_AUTONOMOUS"
...
class ChaosType(str, Enum):
    ...
    WEBHOOK_REPLAY_STORM = "WEBHOOK_REPLAY_STORM"
    GEMINI_OUTAGE = "GEMINI_OUTAGE"
